...
TEST_F(RateLimitFilterTest, OK) {
  ...
  request_callbacks_->complete(Filters::Common::RateLimit::LimitStatus::OK, nullptr, nullptr, "", nullptr);
...
TEST_F(RateLimitFilterTest, Error) {
  ...
  EXPECT_CALL(filter_callbacks_, continueReading());
  request_callbacks_->complete(Filters::Common::RateLimit::LimitStatus::Error, nullptr, nullptr, "", nullptr);
...
TEST_F(RateLimitFilterTest, ImmediateOK) {
  ...
  EXPECT_CALL(*client_, limit(_, "foo", _, _))
      .WillOnce(
          WithArgs<0>(Invoke([&](Filters::Common::RateLimit::RequestCallbacks& callbacks) -> void {
            callbacks.complete(Filters::Common::RateLimit::LimitStatus::OK, nullptr, nullptr, "", nullptr);
          })));
...
TEST_F(RateLimitFilterTest, ImmediateError) {
  ...
  EXPECT_CALL(*client_, limit(_, "foo", _, _))
      .WillOnce(
          WithArgs<0>(Invoke([&](Filters::Common::RateLimit::RequestCallbacks& callbacks) -> void {
            callbacks.complete(Filters::Common::RateLimit::LimitStatus::Error, nullptr, nullptr, "", nullptr);
          })));
